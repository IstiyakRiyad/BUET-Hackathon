  ...
  return (
    <Container className={styles.wrapper}>
      ...
      <p>
        ...
        of Tuni Soft's Website, located at https://tuni.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Tuni if you do not agree to take all
      ...
      <p>
        We employ the use of cookies. By accessing Tuni, you agreed to use
        cookies in agreement with the Tuni Soft's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Tuni Soft and/or its licensors own the
        intellectual property rights for all material on Tuni. All intellectual
        property rights are reserved. You may access this from Tuni for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Tuni</li>
        <li>Sell, rent or sub-license material from Tuni</li>
        <li>Reproduce, duplicate or copy material from Tuni</li>
        <li>Redistribute content from Tuni</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Tuni
        Soft does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Tuni Soft,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Tuni Soft shall not be liable for
      ...
      <p>
        Tuni Soft reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Tuni Soft a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Tuni Soft; and (d) the link is
      ...
      <p>
        ...
        e-mail to Tuni Soft. Please include your name, your organization name,
      ...
      <p>
        No use of Tuni Soft's logo or other artwork will be allowed for linking
